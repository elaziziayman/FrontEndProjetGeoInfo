...
export default function Citoyens() {
  ...
  return (
    ...
    <div>
      ...
      <Button variant="contained" color="success" onClick={handleButtonClick} sx={{ fontSize: '13px' }} href='/createAdmin'>
        Ajouter un Admin
      </Button>
      
    </div>

                  <AttClients title="Comptes Admin" rows={rows} paginationEnabled showAction={true} />
                </Paper>
              </Grid>
            </Grid>
          </Container>
