...
function createData(id, num, autorisation, occupation, commune, date,motif) {
    return {id, num, autorisation, occupation, commune, date,motif};
  }
  ...
  const rows = [
    ...
    createData(
      ...
      'Arrondissement El Fida',
      '16 Mar, 2019',
      'Non-conformité aux normes architecturales',
    ),
    createData(
      3,
      4,
    ...
    createData(
      ...
      'Arrondissement El Fida',
      '16 Mar, 2019',
      'Non-conformité au code du bâtiment',
    ),
    createData(
        5,
        6,
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                  <Orders title="Mes demandes rejetées" rows={rows} paginationEnabled showMotif={true} />
                </Paper>
              </Grid>
            </Grid>
          </Container>
