...
import { getDemandesEnInstance} from "../../API"; 
...
function createData(id, num, demandeur, cin ,autorisation, occupation, commune, date) {
    return {id, num, demandeur,cin, autorisation, occupation, commune, date};
  }
...
export default function DemandesEnInstanceAdmin() {
  ...
  useEffect(() => {
    setLoading(true);
  getDemandesEnInstance().then((res) => {
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                  <OrdersAdmin title="Les demandes en instance" rows={rows} paginationEnabled showStatus={false} loading={loading} showActions={true} />
                </Paper>
              </Grid>
            </Grid>
          </Container>
